...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">中华军火库</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> 武器添加</h1>
          <p>New weapons</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Forms</li>
          <li class="breadcrumb-item"><a href="#">武器添加</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-10" >
                ...
                <form id="myForm" name="myForm" action="${pageContext.request.contextPath}/sy/addtodb.do" method="post">
                  ...
                  <div class="form-group">
                    <label >重量</label>
                    <input class="form-control" id="weigh" name="weigh" type="text" >
                  </div>
                  <div class="form-group">
                    <label >武器分类</label>
        ...
        $(function(){
            $("#myForm").validate({
                ...
                messages:{
                    ...
                    "unit":{required:"不能为空"},
                    "weigh":{required:"不能为空"},
                    "price":{required:"不能为空",number:"必须为正整数"}
                }
            });
        })
    </script>
